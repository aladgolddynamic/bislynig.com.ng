                ...
                <div className="lg:grid lg:grid-cols-12 lg:gap-8 items-center">
                    <div className="lg:col-span-6 text-left" data-purpose="hero-content">
                        <h1 className="text-4xl font-extrabold tracking-tight text-[#1A1A1A] sm:text-5xl md:text-6xl lg:leading-tight">
                            Empowering Businesses Through <span className="text-[#B30000]">Innovative Technology</span>
                        </h1>
                        ...
                        <div className="mt-10 flex flex-col sm:flex-row gap-4">
                            <Link
                                className="w-full sm:w-auto px-8 py-4 bg-[#B30000] text-white font-bold rounded shadow-lg hover:bg-[#8B0000] text-center transition"
                                href="#services"
                            >
                                Explore Services
                            </Link>
                    ...
                    <div className="mt-12 lg:mt-0 lg:col-span-6" data-purpose="hero-image">
                        <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                            ...
                            />
                            <div className="absolute inset-0 bg-gradient-to-tr from-[#B30000]/10 to-transparent pointer-events-none"></div>
                        </div>
                    </div>
                </div>
            </div>
