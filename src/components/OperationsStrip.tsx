    ...
    return (
        <section className="relative py-24 lg:py-32 flex items-center justify-center" id="operations">
            ...
            <div className="relative z-10 w-full max-w-4xl mx-auto px-4 flex justify-center py-6">
                <div className="bg-bislyRed px-8 py-8 md:px-12 md:py-10 rounded-2xl shadow-2xl text-center max-w-[600px] w-full transform hover:scale-110 transition-all duration-150 hover:ring-1 hover:ring-white/50">
                    ...
                    <Link
                        href="#contact"
                        className="inline-block px-8 py-3 bg-white text-bislyRed font-bold text-sm md:text-base rounded shadow-lg hover:shadow-xl hover:bg-gray-50 transition-all duration-300 animate-bounce"
                    >
