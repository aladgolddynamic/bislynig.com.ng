...
export default function CTASection() {
    return (
        <section className="py-20 bg-bislyRed text-white" id="contact">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="flex flex-col sm:flex-row justify-center gap-4">
                    <Link href="mailto:info@bislynig.com.ng" className="px-8 py-4 bg-white text-bislyRed font-bold rounded shadow-lg hover:bg-gray-100 transition">
                        Email Us Now
                    </Link>
